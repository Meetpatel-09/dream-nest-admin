...
<nav className="navbar navbar-expand-sm bg-light navbar px-4 h-5">
  <div className="container-fluid">
    <Link className="navbar-brand" to="to">Shri Ram Selection</Link>
    ...
    <div className="collapse navbar-collapse" id="mynavbar">
      <ul className="navbar-nav me-auto">
        ...
        <li className="nav-item dropdown">
          <Link className="nav-link dropdown-toggle" to="#" role="button" data-bs-toggle="dropdown">Category</Link>
      ...
      <li className="nav-item dropdown " style={{listStyle: 'none'}}>
          ...
          <i role="button" className=" cursor-pointer mdi mdi-account" > </i> 
            Profile</Link>
          <ul className="dropdown-menu">
            <li><Link className="dropdown-item" to="#"> <i role="button"  className="mdi mdi-account  text-primary"></i>  Profile</Link></li>
            <li><Link className="dropdown-item" to="/"><i role="button"  className="mdi mdi-logout text-primary"></i>  Logout</Link></li>
          </ul>
        </li>
      ...
      <div>
        <Link to="#" className="m-0 text-decoration-none">
        <i role="button" className=" cursor-pointer mdi mdi-cart" > </i> Cart</Link>
      </div>
...
{/* <!-- main Section --> */}
<div id="carouselExampleCaptions" className=" container my-2 carousel slide p-0" data-bs-ride="carousel">
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src="/images/shirt/s1.jpeg" className="d-block w-100" alt="..."/>
      <div className="carousel-caption d-none d-md-block text-black">
        <h3> Best Collections</h3>
        <h1 className = "text-uppercase py-2 fw-bold">New Arrivals</h1>
        <button className="btn btn-outline-dark" type="submit">Shop Now</button>
...
<div className = "container">
    <div className = "title text-center py-5">
        <h2 className = "position-relative d-inline-block bg-light">New Arrivals</h2>
    </div>
    ...
    <div className = "special-list row g-0">
        <div className = "col-md-6 col-lg-4 col-xl-3 p-2">
            ...
            <div className = "text-center">
                ...
                <span className = "fw-bold d-block">$ 45.50</span>
                  <Link to = "#" className = "btn btn-outline-dark mt-3">Watch More</Link>
            </div>
        </div>
        ...
        <div className = "col-md-6 col-lg-4 col-xl-3 p-2">
            <div className = "special-img position-relative overflow-hidden">
                <img alt=""  src = "/images/T-shirt&Shirt/t2.jpg" className = "w-100"/>
                <span className = "position-absolute d-flex align-items-center justify-content-center text-primary fs-4">
                  <Link to="#" className="text-white text-decoration-none text-muted fs-4 me-4">
                    <i className = "fas fa-heart"></i></Link>
                </span>
  ...
  <div className="container">
     <div className="row">
        <div className="col-md-6">
           <div><img alt=""  src="/images/m1.jpg" className="about_img w-75 m-4"/></div>
        </div>
        <div className="col-md-6">
           <h1 className=" mt-5 about_taital padding_top0">About Shop</h1>
           <div className="border"></div>
           <p className="about_text mt-10"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti quasi quas dolore officia? Culpa eius recusandae repellat repellendus nemo placeat, facere suscipit saepe commodi officiis facilis amet.consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitationconsectetur adipiscing </p>
            {/* <div className="read_bt_1"><a href="#">Read More</a></div> */}
           <div className="image_1"><img alt=""  src="/images/m2.avif" className="w-50 float-end m-4"/>
           </div>
        </div>
     </div>
  </div>
...
<div className="container">
    <div className="row text-white g-4">
        <div className="col-md-6 col-lg-3">
            <Link className="text-uppercase text-decoration-none brand text-white" to="#">Shri Ram Selection</Link>
